...
//   title: "Infinity MK - Premium Beauty Salon | Putney",
//   description:
//     "Step into a world of beauty and relaxation at Infinity MK. Premier hair, nail, and beauty services in Putney. Book your appointment today.",
//   generator: "v0.app",
// }
    ...
    <div className="m-3 hidden xl:block fixed inset-0 pointer-events-none z-60">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 h-8">
        <svg className="w-full h-full" viewBox="0 0 1200 32" preserveAspectRatio="none">
          <path d="M0,16 Q300,8 600,16 T1200,16" stroke="#8B7355" strokeWidth="1.5" fill="none" opacity="1" />
          <path d="M0,20 Q300,12 600,20 T1200,20" stroke="#B8860B" strokeWidth="1" fill="none" opacity="1" />
        </svg>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-8">
        <svg className="w-full h-full" viewBox="0 0 1200 32" preserveAspectRatio="none">
          <path d="M0,16 Q300,24 600,16 T1200,16" stroke="#8B7355" strokeWidth="1.5" fill="none" opacity="1" />
          <path d="M0,12 Q300,20 600,12 T1200,12" stroke="#B8860B" strokeWidth="1" fill="none" opacity="1" />
        </svg>
      </div>

      {/* Left-top border with stem */}
      <div className="absolute left-0 top-0 bottom-0 right-0 w-8">
        <svg className="w-full h-[45%]" viewBox="0 0 32 800" preserveAspectRatio="none">
          <path d="M16,0 Q8,200 16,400 T16,800" stroke="#8B7355" strokeWidth="1.5" fill="none" opacity="1" />
          <path d="M20,0 Q12,200 20,400 T20,800" stroke="#B8860B" strokeWidth="1" fill="none" opacity="1" />
        </svg>
      </div>

      {/* Left-bottom border with stem */}
      ...
      <div className="absolute right-0 top-0 bottom-0 w-8">
        <svg className="w-full h-full" viewBox="0 0 32 800" preserveAspectRatio="none">
          <path d="M16,0 Q24,200 16,400 T16,800" stroke="#8B7355" strokeWidth="1.5" fill="none" opacity="1" />
          <path d="M12,0 Q20,200 12,400 T12,800" stroke="#B8860B" strokeWidth="1" fill="none" opacity="1" />
        </svg>
      </div>
