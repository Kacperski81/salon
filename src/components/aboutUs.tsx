...
export default function AboutUs() {
    return (
        ...
        <section id="about" className="snap-start snap-always py-10 bg-(--main-400) grid justify-items-center content-center gap-12 lg:grid-cols-2 lg:gap-1 xl:gap-16 min-h-screen">
            <div className="relative w-[70%] aspect-[5/4] md:aspect-[5/4] lg:justify-self-end lg:self-center shadow-2xl">
                <Image
                    src={ImageSrc}
                    alt="about image"
                    fill
            ...
            <div className="font-(family-name:--font-lato) px-4 flex flex-col gap-4 xl:gap-6 lg:self-center lg:justify-self-start w-4/5 xl:w-2/3 text-xl">
                <h2 className="font-(family-name:--font-aboreto) text-(--main-100) text-3xl sm:text-4xl lg:text-5xl lg:text-left font-light">About Us</h2>
                <p className="leading-relaxed text-base text-(--main-50) sm:text-lg md:text-xl lg:text-left">{`Nestled just off Putney High Street, a short stroll from the station, Infinity MK is your go-to salon for hair, nail, and beauty needs. We're dedicated to understanding your unique style and providing exceptional service to help you fell good and look amazing.`}</p>
