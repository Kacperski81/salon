...
export default function AboutUs() {
    return (
        <Section>
            ...
            <main className="bg-(--main-400) bg-blend-multiply py-10 
                grid justify-items-center content-center gap-12 
                xl:grid-cols-2 lg:gap-12 xl:gap-16 min-h-dvh xl:min-h-screen">
