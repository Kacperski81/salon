...
export default function AboutUs() {
    return (
        ...
        <section id="about" className="snap-start snap-always py-10 bg-(--main-400) grid justify-items-center content-center gap-12 xl:grid-cols-2 xl:gap-16 min-h-screen">
