...
export default function Footer() {
    ...
    return (
        ...
        <footer id="footer" className="text-center bg-(--main-800) min-h-dvh xl:min-h-screen py-2 sm:py-10 flex items-center">
            {/* container */}
                ...
                <div className="space-y-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-3">
                    ...
                    <div className="space-y-1">
                        ...
                        <ul className="space-y-2 text-sm sm:text-lg text-stone-800">
                            ...
                            <li>
                                <Link href="/nail" className={`transition-colors duration-300 ${isFooterLinkActive("/nail") ? "text-[#B8860B] font-semibold" : "hover:text-[#B8860B]"} ${isFooterLinkActive("/nails") ? "text-(--main-100)" : "text-(--main-300)"}`}>Nails Services</Link>
                            </li>
                            <li>
